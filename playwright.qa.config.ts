...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'desktop', testMatch: /(golden-path|roles-ui|service-order-governance|visual|decisions-ui|shell-hydration|payroll-email-ui|dashboard-finite|decisions-zero)\.spec\.ts$/,
