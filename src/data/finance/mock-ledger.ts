...
function generateBackfill(): LedgerEntry[] {
  ...
  const recipes: BackfillRecipe[] = [
    ...
    { label: 'Hospedagem Macaé',           category_id: 'cat-b21', cost_center_id: 'cc-mob',       business_unit_id: 'bu-rj', project_id: 'proj-1', supplier_id: 'sup-1', monthly_actual_cents:  74_000_00, monthly_budget_cents:  70_000_00 },
    { label: 'Passagens aéreas',           category_id: 'cat-b22', cost_center_id: 'cc-mob',       business_unit_id: 'bu-rj', project_id: 'proj-1', supplier_id: 'sup-2', monthly_actual_cents:  18_000_00, monthly_budget_cents:  20_000_00 },
    { label: 'Locação veículos',           category_id: 'cat-b23', cost_center_id: 'cc-mob',       business_unit_id: 'bu-rj', project_id: 'proj-2', supplier_id: 'sup-3', monthly_actual_cents:  21_000_00, monthly_budget_cents:  18_000_00 },
  ...
  for (const period of BACKFILL_PERIODS) {
    for (const recipe of recipes) {
      ...
      if (period <= '2026-04') {
        out.push(bf(prefix, period, 'actual', recipe));
      }
    }
  }
  return out;
