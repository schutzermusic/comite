...
interface GlobeSlotProps {
    ...
    /** Hide built-in text overlays (for full-screen Control Room use) */
 ...
 */
export function GlobeSlot({ className, minHeight = 420, hideOverlays = false }: GlobeSlotProps) {
    ...
    return (
        ...
        >
            {/* 
              GRADIENT MASK OVERLAYS (REMOVED for clearer 3D view)
            ...
            */}
            ...
            {/* 
              ...
              Hidden in full-screen Control Room mode
            */}
            {!hideOverlays && (
                <motion.div
