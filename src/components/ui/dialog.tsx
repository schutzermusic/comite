...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /**
     * `default` — layout padrão (grid, gap e padding internos).
     * `flush` — sem padding/gap: o consumidor controla o layout interno
     * (ex.: cabeçalho/rodapé fixos + corpo rolável). Evita overrides `!important`.
     */
    size?: "default" | "flush"
  }
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        size === "default" ? "grid gap-4 p-6" : "flex flex-col overflow-hidden",
        className
      )}
      {...props}
    >
