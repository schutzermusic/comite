...
const VARIANT_STYLES: Record<HudButtonVariant, string> = {
  primary: [
    ...
    'font-semibold',
    'border-0',
    'shadow-[inset_0_1px_0_rgba(255,255,255,0.22),inset_0_-1px_0_rgba(0,0,0,0.20),0_3px_8px_rgba(15,156,143,0.18),0_1px_2px_rgba(0,0,0,0.35)]',
    'hover:brightness-105 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.28),inset_0_-1px_0_rgba(0,0,0,0.22),0_5px_14px_rgba(15,156,143,0.26),0_1px_2px_rgba(0,0,0,0.35)]',
