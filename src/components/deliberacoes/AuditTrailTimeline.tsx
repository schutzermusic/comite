...
const ACTION_CONFIGS: Record<AuditTrailEntry['action'], {
    ...
    'entered_review':       { icon: ClipboardCheck,    colorClass: 'text-ig-warning', bgClass: 'bg-[color-mix(in_oklab,var(--ig-warning)_16%,transparent)] border-[color-mix(in_oklab,var(--ig-warning)_28%,transparent)]', label: 'Entrou em Revisão' },
